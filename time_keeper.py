...
img = PhotoImage(file='icon.gif')  # Make sure this file is in the same spot as the binary or it will break
...
current_date = date.today()  # Pulling current date for usage in the entry box autopop, needs formatted in the actual function
...
def clock_in():  # Function of the button
    ...
    # This block below is for autopopulating the entry boxes with the pulled info
...
It looks like they are trying to print the contents of the list that we use earlier on, don't know why
A chunk of the gui code was copied and modified, could just be a leftover usage that is not needed for this program
Will leave in here for the time being just in case
#print(lst)
#print(main_lst)
'''
